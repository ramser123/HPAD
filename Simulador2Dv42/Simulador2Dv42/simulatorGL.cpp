...
void runAutoTest(int argc, char **argv)
{
    ...
    const char *image_path = sdkFindFilePath("texture_map.bmp", argv[0]);
    if (image_path == NULL) {
       printf( "imageDenoisingGL was unable to find and load image file <texture_map.bmp>.\nExiting...\n");
       shrQAFinishExit(argc, (const char **)argv, QA_FAILED);
    }
